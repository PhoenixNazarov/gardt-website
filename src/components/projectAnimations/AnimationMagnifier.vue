...
export default {
  ...
  methods: {
    onMove: function (event) {
      ...
      let offsetXp = x / this.width;
      let offsetYp = y / this.height;
      let offsetX = clamp(-this.widthBig * offsetXp + this.offsetWidth / 2, -this.widthBig + this.offsetWidth , 0);
      let offsetY = clamp(-this.heightLoop * offsetYp + this.offsetHeight / 2, -this.heightLoop + this.offsetHeight, 0);
