...
export const uefaData = [
    ...
    },
    {
        ...
        data: {
            description1: translate('Территория ЖК разделена на тихие и уютные дворы, пешеходный бульвар, общественные пространства (локальная площадь и детская игровая зона) и природные локации для отдыха'),
